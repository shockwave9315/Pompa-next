...
Current status: **Stage 1 — Core Backend.** The backend records canonical minutes from MQTT into MariaDB and serves 1-minute history and status; see [backend/README.md](backend/README.md). No frontend yet.
