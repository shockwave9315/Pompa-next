...
Current status: **Stage 1 — Core Backend is ready to begin.** This repository currently contains documentation and device reference material only; no production backend or frontend has been implemented.
